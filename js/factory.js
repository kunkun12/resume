	...
	var appFactory=function(resumeApp){
      ...
      resumeApp.factory('Experiencefo', function() {
         ...
         resumeApp.factory('skillInfo', function() {
           return [ "JS：扎实的JavaScript/HTML/CSS 基础、熟悉Angluarjs、Dojo、Vue.js、jQuery、Zepto、Underscore、D3.js等。熟悉AMD、CommonJS规范、熟悉使用Dojo、RequireJS模块化开发，能够使用r.js优化AMD程序。了解ES6",
